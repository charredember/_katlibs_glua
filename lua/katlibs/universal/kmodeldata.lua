...
---@deprecated This should be replaced with stream write/read methods.
---@return table
...
function KModelData:GetRenderProperties()
    ...
    if color.r ~= defaultColor.r or color.g ~= defaultColor.g or color.b ~= defaultColor.b then
    ...
    if material ~= defaultValues.Material then
